...
const tracks: Track[] = [
  {
    ...
    modules: [
      {
        week: "Week 1",
        title: "Avalanche Fundamentals & Wallets",
      ...
      },
      {
        ...
        outcomes: ["Integrate USDC on Avalanche", "Build a merchant checkout", "Handle invoices & receipts on-chain"],
        tools: ["USDC", "Hardhat", "Viem / Ethers"],
      },
      {
        week: "Week 3",
        title: "M-Pesa Bridges & Consumer Payments",
        outcomes: ["Bridge fiat ↔ stablecoin", "Mobile-first payment UX", "KYC + compliance basics"],
        tools: ["Daraja API", "Webhooks", "Edge Functions"],
      },
      {
        week: "Week 4",
        title: "Cross-Border & Ship Demo",
        outcomes: ["Cross-border remittance flow", "Settlement + treasury", "Public demo + waitlist live"],
        tools: ["ICTT", "Snowtrace", "Posthog"],
      },
    ],
  },
  {
    ...
    theme: "Building Sticky Consumer Experiences",
    description: "Product design, XP systems, leaderboards, loyalty engines and consumer onboarding patterns — designed for retention.",
    icon: Gamepad2,
    ...
    modules: [
      {
        ...
        outcomes: ["Map a sticky core loop", "Design onboarding for non-crypto users", "Wallet abstraction patterns"],
        tools: ["Figma", "Privy / Para", "Smart accounts"],
      },
      {
        week: "Week 2",
        title: "XP, Quests & Leaderboards",
        outcomes: ["Design XP + level systems", "Quest engines on-chain", "Public leaderboards"],
        tools: ["Soulbound NFTs", "The Graph", "Supabase"],
      },
      {
        week: "Week 3",
        title: "Loyalty & Rewards",
        outcomes: ["Token / point hybrid loyalty", "Streaks & retention loops", "Referral mechanics"],
        tools: ["ERC-20", "Merkle drops", "Branch / Linktree"],
      },
      {
        week: "Week 4",
        title: "Web3 Gaming Concepts & Demo",
        outcomes: ["Mini-game prototype", "Sponsored transactions", "Live cohort demo"],
        tools: ["Phaser / Unity", "Paymasters", "Lovable"],
      },
    ],
  },
  {
    ...
    theme: "Building Autonomous AI Systems",
    ...
    modules: [
      {
        week: "Week 1",
        title: "AI Agents 101",
        outcomes: ["Agent architectures", "Tool-use & function calling", "Memory + context windows"],
        tools: ["OpenAI / Anthropic", "LangGraph", "Vercel AI SDK"],
      },
      {
        week: "Week 2",
        title: "LLM Workflows & Automation",
        outcomes: ["Multi-step workflows", "Background jobs", "Eval + observability"],
        tools: ["Inngest", "Trigger.dev", "Langfuse"],
      },
      {
        week: "Week 3",
        title: "Autonomous Payments & On-chain Actions",
        outcomes: ["Agent-controlled smart accounts", "Spending limits & policies", "On-chain triggers"],
        tools: ["Smart wallets", "Session keys", "Chainlink Automation"],
      },
      {
        week: "Week 4",
        title: "Orchestration & Hackathon Kickoff",
        outcomes: ["Multi-agent orchestration", "Production deployment", "Pitch your agent at Demo Day"],
        tools: ["Mastra", "ICM", "Snowtrace"],
      },
    ],
  },
];
